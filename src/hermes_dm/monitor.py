...
def main():
    parser = argparse.ArgumentParser(description="Hermes Monitor: Connect an instrument and stream live data.")
    ...
    try:
        ...
        try:
            ...
            logging.debug(f"Failed to stop logging (daemon likely dead): {e}")
